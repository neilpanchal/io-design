! function() {
    window.$K = {
        ...
        navigation: {
            ...
            toggleChilds: function(t, e) {
                var i = e && "none" === e || $(t).hasClass("k-nav-open"),
                    n = t.siblings("ul");
                n.length && (i ? $(t).addClass("k-nav-open") : $(t).addClass("k-nav-open"), n.css("display", i ? "block" : "block"))
            },
            nest: function() {
                var t = $("a.k-nav-set");
                this.sets.length !== t.length && (this.sets = t, $.each(this.sets, $.proxy(function(t, e) {
                    null === e.onclick && (e.onclick = $.proxy(function(t) {
                        // $(".k-nav-current").removeClass("k-nav-current"), this.toggleChilds($(e)), t.preventDefault()
                    }, this))
        ...
        textPreview: function(t, e) {
            var i = "/text/" + (e ? "" : "drafts/") + "selection:" + t,
                n = this.location.host + this.location.real_root_folder + "/admin/#" + i;
            $("<div/>").attr("id", "k_essay_preview").html('You are previewing a draft of this essay. <a href="' + n + '" title="Return to the console">Go back and make edits</a>.').prependTo("body")
        },
